...
Es hat den Charakter eines \emph{System Design Documents} (SDD) und dokumentiert
...
\begin{itemize}
  ...
  \item \textbf{Out of Scope:} PC-Anwendung, ROS-Integration, WLAN-Kommunikation,
...
Das SDD richtet sich an Entwicklerinnen und Entwickler, die
\begin{enumerate}
...
\begin{description}
  \item[Normal Operation (Gelb/Grün)]
    Der \emph{TTC-Observer} (Time-To-Collision) überwacht die Umgebung und erlaubt
    eine automatische Reaktion auf Hindernisse.  Der Fahrvorgang wird angepasst,
    das Fahrzeug kann aber weiterfahren.  TTC ist \textbf{kein} Bestandteil des
